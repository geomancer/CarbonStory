...
Scientists could see that the amount of carbon dioxide (CO₂) in the air was going up. But the big question was: why?

The answer comes from something called the **Suess Effect**, which works like a fingerprint. Carbon comes in different types, called isotopes. Some are heavier (like carbon-13 and carbon-14), and some are lighter (carbon-12). Fossil fuels—like coal, oil, and gas—are very old, and they mostly contain the lighter kind, carbon-12.

When humans burn fossil fuels, we release a lot of carbon-12 into the air. This extra carbon-12 “dilutes” the heavier kinds of carbon in the atmosphere and oceans. Scientists can measure this change. As CO₂ levels rise, the balance between carbon-13 and carbon-12 shifts, showing more carbon-12 than before.

This change proves that the extra CO₂ is coming from human activities, not from natural cycles like volcanoes or plant growth. The Suess Effect helps scientists track where carbon goes—into the air, the oceans, or the land—and use that information to understand climate change and figure out how to reduce its impact. In these graphs, one moves up, the other down; both with seasonal variations.

```{r suess-plot, message=FALSE, warning=FALSE}
